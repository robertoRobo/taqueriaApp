package md5090a858f93e521d645cf0c4f1147275b;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.TextToSpeech.TtsProgressListener, Plugin.TextToSpeech, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TtsProgressListener.class, __md_methods);
	}
	...
	public TtsProgressListener ()
	{
		...
		if (getClass () == TtsProgressListener.class)
			mono.android.TypeManager.Activate ("Plugin.TextToSpeech.TtsProgressListener, Plugin.TextToSpeech, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
