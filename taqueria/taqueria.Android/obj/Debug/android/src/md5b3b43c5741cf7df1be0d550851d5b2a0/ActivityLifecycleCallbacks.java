package md5b3b43c5741cf7df1be0d550851d5b2a0;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Acr.UserDialogs.Infrastructure.ActivityLifecycleCallbacks, Acr.UserDialogs, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ActivityLifecycleCallbacks.class, __md_methods);
	}
	...
	public ActivityLifecycleCallbacks ()
	{
		...
		if (getClass () == ActivityLifecycleCallbacks.class)
			mono.android.TypeManager.Activate ("Acr.UserDialogs.Infrastructure.ActivityLifecycleCallbacks, Acr.UserDialogs, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
